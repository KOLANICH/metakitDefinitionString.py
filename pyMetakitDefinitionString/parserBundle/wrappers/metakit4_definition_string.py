...
class subFieldsParser(IWrapper):
	...
	def process_delimited_scalarOrView_(self, parsed) -> typing.Iterable[typing.Union[scalar, view]]:
		...
		for f in self.backend.wstr.iterateCollection(parsed.rest_subFields_with_del):
			yield f.rest_subField

	def process_delimited_scalarOrView(self, parsed) -> typing.Iterable[typing.Union[scalar, view]]:
